...
<template>
  <div>
    ...
    <a-spin :spinning="loading">
      <NewTemplateIsoRadioGroup
        :osList="items[filterType][inputDecorator.slice(0, -2)] || []"
        :itemCount="items[filterType].count || 0"
...
<script>
import NewTemplateIsoRadioGroup from '@views/compute/wizard/NewTemplateIsoRadioGroup'
