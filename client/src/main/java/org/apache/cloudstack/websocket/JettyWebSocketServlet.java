...
public class JettyWebSocketServlet extends WebSocketServlet {
    ...
    public void init() throws ServletException {
        ...
        String wsPortStr = ServerPropertiesUtil.getProperty("websocket.server.port");
        enabled = StringUtils.isBlank(wsPortStr);
        if (!enabled) {
            LOGGER.info("JettyWebSocketServlet is disabled: standalone websocket.server.port is set");
            throw new UnavailableException("WS disabled: standalone websocket.server.port is set");
        }
        super.init();
    }
    ...
    public void configure(WebSocketServletFactory factory) {
        ...
        try {
            ...
            LOGGER.error("JettyWebSocketServlet servlet configure() failed", t);
