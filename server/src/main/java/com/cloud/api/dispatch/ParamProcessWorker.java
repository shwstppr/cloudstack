        ...
        for (final Field field : cmdFields) {
            ...
            try {
                ...
                if (s_logger.isDebugEnabled()) {
                    s_logger.debug("Unable to execute API command " + commandName + " due to invalid value " + paramObj + " for parameter " +
                ...
                if (s_logger.isDebugEnabled()) {
                    s_logger.debug("Invalid date parameter " + paramObj + " passed to command " + commandName);
                }
